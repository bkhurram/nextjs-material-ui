			...
			<Container>
				...
				{isSubmitSuccessful
					? (<div style={{ textAlign: "center" }}>
						...
						<Typography color={green[900]}> <strong>Data sent successfully</strong></Typography>
					</div>
					)
					: (
						<form onSubmit={handleSubmit(onSubmit)}>
							<Grid container spacing={3}>
								<Grid item xs={12} sm={6}>
									<TextField
										{...register("firstName", {
											...
											maxLength: { value: 20, message: 'exceeded the limit of 20 characters' }
										})}
										id="firstName"
										label="First name"
										fullWidth
								...
								<Grid item xs={12}>
									<TextField
										{...register("address", { required: { value: true, message: 'Field is required' } })}
										id="address"
										label="Address line"
										fullWidth
								...
								<Grid item xs={12} sm={6}>
									<TextField
										{...register("city", { required: { value: true, message: 'Field is required' } })}
										id="city"
										label="City"
										fullWidth
